...
window.SITE_CONFIG = {
  ...
  logo: 'assets/logo.svg',            // 【可改】Logo 图片地址（导航栏 + 页脚）
  ...
  social: [                           // 【可改】页脚社交链接；icon 可选 github/mail/rss
    ...
    { name: 'Email', url: 'mailto:hello@rsnotes.dev', icon: 'mail' },
  ...
  hero: {
    ...
    background: {
      image: '',           // 【可改】背景图 URL，如 'https://example.com/bg.jpg'；留空用渐变
    ...
    /* ===== 粒子网络配置 =====
       数值越小越疏散，连线距离越大连线越密集。 */
    particles: {
      count: 80,           // 【可改】桌面端粒子数量（越小越疏散，建议 40~120）
      countMobile: 26,     // 【可改】移动端粒子数量
      linkDistance: 0.13,  // 【可改】连线归一化距离 0~1（0=无连线，越大连线越密）
      size: 2.4,           // 【可改】粒子点大小
      opacity: 0.85,       // 【可改】粒子透明度 0~1
      color: '#ffffff'     // 【可改】粒子颜色（十六进制，建议与背景反色）
    }
  }
};
